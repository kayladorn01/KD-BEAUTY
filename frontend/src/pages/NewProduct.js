                ...
                <Col md={6} className="new-product__form--container">
                    <Form style={{ width: "100%" }} onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control type="number" placeholder="Price (R)" value={price} required onChange={(e) => setPrice(e.target.value)} />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3" onChange={(e) => setCategory(e.target.value)}>
                            ...
                            <Form.Select>
                                ...
                                <option value="makeuptools">Makeup Tools</option>
                            </Form.Select>
                        </Form.Group>
